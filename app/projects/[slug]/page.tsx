...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className={`project-page accent-${project.accent}`}>
    <nav className="project-nav container"><Link className="brand" href="/"><span className="brand-mark">R</span><span>RAHUL<span className="muted">VERSE</span></span></Link><div className="project-nav-actions"><Link href="/projects">← All projects</Link></div></nav>
