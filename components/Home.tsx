    ...
    <main>
      <header className="nav-wrap">
        <nav className="nav container" aria-label="Primary navigation">
          <a href="#top" className="brand" aria-label="RahulVerse home"><span className="brand-mark">R</span><span>RAHUL<span className="muted">VERSE</span></span></a>
      ...
      <footer><div className="container footer-inner"><a href="#top" className="brand"><span className="brand-mark">R</span><span>RAHUL<span className="muted">VERSE</span></span></a><p>Designed & engineered with curiosity.<br/>© 2026 Rahul Kumar.</p><a href="#top">Back to orbit ↑</a></div></footer>
