...
export default function ProjectArchive({ projects }: { projects: Project[] }) {
  ...
  return <main className="archive-page">
    <nav className="project-nav container"><Link className="brand" href="/"><span className="brand-mark">R</span><span>RAHUL<span className="muted">VERSE</span></span></Link><div className="project-nav-actions"><Link href="/">← Home</Link></div></nav>
